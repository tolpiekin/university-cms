...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET,(new String[] {"/api/courses/**", "/api/groups/**"})).hasAnyRole("STUDENT", "TUTOR", "STUFF", "ADMIN")
                .antMatchers(HttpMethod.DELETE,(new String[] {"/api/courses/**", "/api/groups/**"})).hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.POST,(new String[] {"/api/courses/**", "/api/groups/**"})).hasAnyRole("STUFF", "ADMIN")
                .antMatchers(HttpMethod.PUT,(new String[] {"/api/courses/**", "/api/groups/**"})).hasAnyRole("STUFF", "ADMIN")
